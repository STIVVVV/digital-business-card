        ...
        <div>
            ...
            <ul className="skills--text">
                ...
                <li>
                    ...
                    and the kiss philosophy and within the development cycle.
                </li>
                <li>Managed source control for my projects with GitHub, Source tree, Git graph, and GitHub desktop</li>
            </ul>
        </div>
    )
}